...
func main() {
	...
	flag.BoolVar(&cfg.limiter.enabled, "limiter-enabled", true, "Enable rate limitter")

	flag.StringVar(&cfg.smtp.host, "smtp-host", "smtp-mail.outlook.com", "SMTP host")
	flag.IntVar(&cfg.smtp.port, "smtp-port", 587, "SMTP port")
	flag.StringVar(&cfg.smtp.username, "smtp-username", "libercopia@outlook.com", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "Lzrbt95fU$VC3(W", "SMTP password")
